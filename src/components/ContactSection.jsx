import { Github, Instagram, Linkedin, Mail, Map, MapPin, Phone, Send } from "lucide-react";
                ...
                <div className="space-y-6 justify-center">
                    <div className="flex items-start space-x-4">
                        ...
                        <div>
                            ...
                            <a href="mailto:kevinsurya1212@gmail.com" className="text-muted-foreground hover:text-primary transition-colors">
                                kevinsurya1212@gmail.com
                            </a>
                        </div>
                    </div>
                    <div className="flex items-start space-x-4">
                        ...
                        <div>
                            ...
                            <a href="tel:+6288232434440" className="text-muted-foreground hover:text-primary transition-colors">
                                (+62) 88232434440
                            </a>
                        </div>
                    </div>
                ...
                <form className="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea 
                            ...
                            placeholder="Hello Kevin, i'd like to talk about..."
                            />
                    </div>
